...
export default function Navbar() {
  ...
  const { darkMode, toggleDarkMode, auth, logout } = useStore()
  ...
  const navItems = auth.isAuthenticated ? authenticatedNavItems : publicNavItems
            ...
            {auth.isAuthenticated && (
              <>
                ...
                <button
                  ...
                  className="text-gray-700 dark:text-gray-300 hover:text-red-600 font-medium"
                >
                  Logout
                </button>
              </>
            ...
            <div className="space-y-2">
              ...
              {auth.isAuthenticated && (
                <button
                  ...
                  className="block w-full text-left px-3 py-2 text-gray-700 dark:text-gray-300 hover:text-red-600 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-md font-medium"
                >
                  Logout
                </button>
              )}
